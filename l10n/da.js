OC.L10N.register(
    ...
    "You are using more than %d%% of your storage quota. Try to free up some space by deleting old files you don't need anymore." : "Du bruger mere end %d%% af din lagerkvote. Prøv at frigøre noget plads ved at slette gamle filer, du ikke har brug for længere.",
    ...
    "This app sends notifications to users when they reached 85, 90 and 95% of their quota." : "Denne app sender meddelelser til brugere, når de har nået 85, 90 og 95 % af deres kvote.",
    "This app sends notifications to users when they reached 85, 90 and 95% of their quota (checked once a day).\nIn addition an email can be sent to the users. The three percentages can be changed in the admin settings.\nIt is also possible to have a link in the email and the notification for upsell options." : "Denne app sender meddelelser til brugere, når de har nået 85, 90 og 95 % af deres kvote (tjekket en gang om dagen).\nDerudover kan der sendes en e-mail til brugerne. De tre procenter kan ændres i administratorindstillingerne.\nDet er også muligt at have et link i e-mailen og notifikationen for opsalgsmuligheder."
},
