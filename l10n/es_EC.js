OC.L10N.register(
    ...
    "This app sends notifications to users when they reached 85, 90 and 95% of their quota." : "Esta aplicación envía notificaciones a los usuarios cuando alcanzan el 85%, 90% y 95% de su cuota.",
    "This app sends notifications to users when they reached 85, 90 and 95% of their quota (checked once a day).\nIn addition an email can be sent to the users. The three percentages can be changed in the admin settings.\nIt is also possible to have a link in the email and the notification for upsell options." : "Esta aplicación envía notificaciones a los usuarios cuando alcanzan el 85%, 90% y 95% de su cuota (verificados una vez al día). Además, se puede enviar un correo electrónico a los usuarios. Los tres porcentajes pueden cambiarse en la configuración del administrador. También es posible incluir un enlace en el correo electrónico y la notificación para opciones de mejora o ampliación del servicio."
},
