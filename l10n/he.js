OC.L10N.register(
    ...
    "First notification" : "התרעה ראשונה",
    "Send an email" : "שליחת דוא״ל",
    "Second notification" : "התרעה שנייה",
    "Final notification" : "התרעה סופית",
    "Link to quota management" : "קישור לניהול מכסות",
    "Resend notifications after … days" : "שליחת התרעות שוב לאחר … ימים",
    "Set to 0 if the user should only receive one notification." : "יש להגדיר ל־0 אם המשתמש אמור לקבל התרעה אחת בלבד.",
    "You are using more than %d%% of your storage quota. Try to free up some space by deleting old files you don´t need anymore." : "ניצלת למעלה מ־%d%% ממכסת האחסון שלך. כדאי לנסות לפנות מקום על ידי מחיקת קבצים ישנים שאין לך בהם צורך עוד."
},
