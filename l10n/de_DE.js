OC.L10N.register(
    ...
    "This app sends notifications to users when they reached 85, 90 and 95% of their quota (checked once a day).\nIn addition an email can be sent to the users. The three percentages can be changed in the admin settings.\nIt is also possible to have a link in the email and the notification for upsell options." : "Diese App sendet Benachrichtigungen an Nutzer, wenn das Speicherkontigent 85, 90 und 95% erreicht (wird täglich überprüft).\nZusätzlich kann eine E-Mail an die betreffenden Nutzer versendet werden. Die drei Prozentwerte können in den Administratiren-Einstellungen geändert werden.\nAußerdem ist es möglich, in der E-Mail einen Link einzufügen unter dem mehr Speicherplatz angefordert bzw. erworben werden kann.",
