OC.L10N.register(
    ...
    "This app sends notifications to users when they reached 85, 90 and 95% of their quota (checked once a day).\nIn addition an email can be sent to the users. The three percentages can be changed in the admin settings.\nIt is also possible to have a link in the email and the notification for upsell options." : "Tato aplikace zasílá upozornění uživatelům, kteří dosáhli 85, 90 a 95% jim přidělené kvóty (kontroluje se jednou za den).\nKrom toho je možné poslat uživatelům e-mail. Tyto tři procentuální úrovně je možné změnit v nastavení správy.\nDo e-mailu je také možné vložit odkaz a upozornění na možnost dokoupení kapacity.",
    "First notification" : "První upozornění",
    "Send an email" : "Odeslat e-mail",
    "Second notification" : "Druhé upozornění",
    "Final notification" : "Poslední upozornění",
    "Link to quota management" : "Odkaz na správu kvót",
    "Resend notifications after … days" : "Upozornění poslat znovu za … dnů",
    "Set to 0 if the user should only receive one notification." : "Pokud má uživatel obdržet pouze upozornění pouze jedinkrát, nastavte na hodnotu 0 (nula)."
},
