OC.L10N.register(
    ...
    "This app sends notifications to users when they reached 85, 90 and 95% of their quota." : "Este aplicativo envía notificacións aos usuarios cando acadan o 85, 90 e 95% da súa cota.",
    "This app sends notifications to users when they reached 85, 90 and 95% of their quota (checked once a day).\nIn addition an email can be sent to the users. The three percentages can be changed in the admin settings.\nIt is also possible to have a link in the email and the notification for upsell options." : "Este aplicativo envía notificacións aos usuarios cando acadan o 85, 90 e 95% da súa cota (revisado unha vez ao día).\nAdemais, pódese enviar un correo electrónico aos usuarios. As tres porcentaxes poden cambiarse nos axustes do administrador.\nTamén é posíbel ter unha ligazón no correo electrónico e a notificación das opcións de venda de máis espazo.",
