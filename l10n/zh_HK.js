OC.L10N.register(
    ...
    "This app sends notifications to users when they reached 85, 90 and 95% of their quota." : "此app在用戶使用達到85， 90， 及95%他們的配額時會傳送通知給用戶。",
    "This app sends notifications to users when they reached 85, 90 and 95% of their quota (checked once a day).\nIn addition an email can be sent to the users. The three percentages can be changed in the admin settings.\nIt is also possible to have a link in the email and the notification for upsell options." : "此app在用戶使用達到85、90、及95%他們的配額時會傳送通知給用戶（一天檢查一次）。\n此外電子郵件也會寄給用戶。這三個百分比在管理員設定內可以更改。\n也有可能是電子郵件內有一個連結而且通知是加購的選項。"
},
"nplurals=1; plural=0;");
