...
class Settings implements ISettings {
	...
	public function getForm() {
		...
		$response->setParams([
			'info_percentage' => $this->config->getAppValue('quota_warning', 'info_percentage', 50),
			'info_email' => $this->config->getAppValue('quota_warning', 'info_email', 'no') === 'yes',
			'warning_percentage' => $this->config->getAppValue('quota_warning', 'warning_percentage', 80),
